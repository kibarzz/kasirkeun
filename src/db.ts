...
export const initDB = async () => {
  ...
  try {
    ...
    const alterColumns = [
      ...
      'ALTER TABLE settings ADD COLUMN loyalty_enabled INTEGER DEFAULT 0',
      'ALTER TABLE settings ADD COLUMN tax_enabled INTEGER DEFAULT 0',
      'ALTER TABLE settings ADD COLUMN service_charge_rate REAL DEFAULT 0',
      'ALTER TABLE settings ADD COLUMN service_charge_enabled INTEGER DEFAULT 0',
      'ALTER TABLE products ADD COLUMN image_url TEXT',
      'ALTER TABLE products ADD COLUMN online_base_price REAL DEFAULT 0',
